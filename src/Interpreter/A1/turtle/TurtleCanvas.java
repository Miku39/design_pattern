...
public class TurtleCanvas extends Canvas implements ExecutorFactory {
    final static int UNIT_LENGTH = 30;  // “®‚­‚Æ‚«‚Ì’PˆÊ’·‚³
    final static int DIRECTION_UP = 0; // ãŒü‚«
    final static int DIRECTION_RIGHT = 3; // ‰EŒü‚«
    final static int DIRECTION_DOWN = 6; // ‰ºŒü‚«
    final static int DIRECTION_LEFT = 9; // ¶Œü‚«
    final static int RELATIVE_DIRECTION_RIGHT = 3; // ‰E‚ÉŒü‚­
    final static int RELATIVE_DIRECTION_LEFT = -3; // ¶‚ÉŒü‚­
    final static int RADIUS = 3; // ”¼Œa
